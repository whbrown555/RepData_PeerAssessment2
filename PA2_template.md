...
Take a first cut at matching the sdata$EVTYPE values with the NOAA Standard EVTYPE values using a tool like Excel. The formulas are intact in the column, "NOAA\_EVTYPE\_FIRST\_CUT\_DO\_NOT\_USE\_IN\_ANALYSIS". Note the file: 
